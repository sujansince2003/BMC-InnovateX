      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="flex items-center p-6 bg-gray-50 rounded-xl">
            <Calendar className="h-10 w-10 text-[#008FAD]" />
            <div className="ml-4">
          ...
          <div className="flex items-center p-6 bg-gray-50 rounded-xl">
            <Clock className="h-10 w-10 text-[#008FAD]" />
            <div className="ml-4">
          ...
          <div className="flex items-center p-6 bg-gray-50 rounded-xl">
            <Users className="h-10 w-10 text-[#008FAD]" />
            <div className="ml-4">
          ...
          <div className="flex items-center p-6 bg-gray-50 rounded-xl">
            <Trophy className="h-10 w-10 text-[#008FAD]" />
            <div className="ml-4">
